...
const EXEMPLARS: &[(&str, &[&str], &[&str])] = &[
    ...
    ("ulid", &["01ARZ3NDEKTSV4RRFFQ69G5FAV"], &["", "81ARZ3NDEKTSV4RRFFQ69G5FAV", "01ARZ3NDEKTSV4RRFFQ69G5FA"]),
    ("domain", &["example.co.uk"], &["", "localhost", "example.123", "-a.example.com"]),
    ("cidr", &["10.0.0.0/8", "2001:db8::/32"], &["", "10.0.0.0", "10.0.0.0/33", "::1/129", "10.0.0.0/08"]),
    ("mac", &["aa:bb:cc:dd:ee:ff", "AA-BB-CC-DD-EE-FF"], &["", "aa:bb:cc:dd:ee", "aa:bb:cc:dd:ee:fg", "aabbccddeeff"]),
    ("time", &["23:59", "23:59:59", "23:59:59.250"], &["", "24:00", "23:60", "9:00", "23:59:60"]),
    ("base64url", &["aGVsbG8", "aGVsbG8="], &["", "aGVs+bG8", "aGVs/bG8", "!!!"]),
    ("alpha", &["Ada"], &["", "Ada1", "Ada Lovelace", "\u{0410}da"]),
    ("numeric", &["00123"], &["", "12a", "-1", "1.5", "\u{FF11}"]),
    ("alpha_dash", &["ada_lovelace-1"], &["", "ada lovelace", "ada.lovelace", "\u{0430}da"]),
    ("lowercase", &["ada", "ada-1 x"], &["", "Ada"]),
    ("uppercase", &["ADA", "ADA-1 X"], &["", "Ada"]),
    ("ascii", &["plain text"], &["", "caf\u{e9}"]),
    ("printable", &["a b c"], &["", "a\tb", "a\nb", "a\u{1b}[31m"]),
    ("semver", &["1.2.3", "1.2.3-beta.1+build.5"], &["", "1.2", "01.2.3", "1.2.3-", "1.2.3-01", "v1.2.3"]),
    ("phone", &["+14155552671"], &["", "14155552671", "+1", "+1 415 555 2671", "+1415555267112345"]),
    ("country_code", &["GB"], &["", "gb", "GBR", "G1"]),
    ("currency_code", &["EUR"], &["", "eur", "EURO", "EU"]),
    ("language_tag", &["en", "en-US", "zh-Hant-TW", "es-419"], &["", "english", "en-", "en-US-x", "EN_US"]),
    ("credit_card", &["4111 1111 1111 1111", "4111-1111-1111-1111"], &["", "4111 1111 1111 1112", "1234", "4111111111111111a"]),
    ("iban", &["GB82WEST12345698765432"], &["", "GB82WEST12345698765433", "gb82west12345698765432", "GB82 WEST 1234 5698 7654 32"]),
    ("hex_color", &["#abc", "#AABBCC", "#ff8800aa"], &["", "abc", "#ff88", "#ggg", "#abcd"]),
    ("json", &["{\"a\":[1,2]}", "[]", "1"], &["", "{a:1}", "{\"a\":}", "undefined"]),
    ("jwt", &["eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIn0.abc-_", "a.b."], &["", "a.b", "a.b.c.d", "a b.c.d", "eyJ+.eyJ.x"]),
];
